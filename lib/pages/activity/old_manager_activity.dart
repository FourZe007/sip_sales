...
class OldManagerActivityPage extends StatefulWidget {
  OldManagerActivityPage({this.isInserted = false, super.key});

  bool isInserted;

  @override
  State<OldManagerActivityPage> createState() => _OldManagerActivityPageState();
}

class _OldManagerActivityPageState extends State<OldManagerActivityPage> {
  ...
  Future<void> fetchData(
    ...
    try {
      ...
      List<ModelManagerActivities> activities =
          await state.fetchManagerActivities();
      setState(() {
