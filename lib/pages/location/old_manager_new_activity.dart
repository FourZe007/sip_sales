...
class OldManagerNewActivityPage extends StatefulWidget {
  const OldManagerNewActivityPage({super.key});

  @override
  State<OldManagerNewActivityPage> createState() =>
      _OldManagerNewActivityPageState();
}

class _OldManagerNewActivityPageState extends State<OldManagerNewActivityPage> {
  // Panel Controller
